...
export const TR = {
  ...
  actTitle: "Basma noktası",
  actHelp: "Analog anahtarların, bir tuşun ne kadar aşağı inince algılanacağını ayarlamana izin verir.",
  actBlocked: "Basma noktasını tarayıcıdan ayarlamak mümkün değil — bunu klavyeye yazan komut hiçbir yerde yayınlanmadı, bu yüzden yalnızca Razer Synapse değiştirebilir. CLI, harici araçlar için ham tuş-derinliği akışını açığa çıkarmak üzere analog sürücü modunu açabilir (--analog on).",
